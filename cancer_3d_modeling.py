...
grid_size = int(input("Enter your grid size (cube) (100/200 good): )"))
grid = np.zeros(((grid_size), (grid_size), (grid_size)))
oxygen_bias = float(input("Oxygen bias (0.1 recommended?)"))
nw_bias = float(input("New Walker probability of spawning: (0.05 recommended) "))
num_steps = int(input("Enter the step count (200-300 recommended): "))
max_walkers = 2500
